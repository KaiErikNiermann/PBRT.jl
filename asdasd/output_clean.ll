...
Box<int>::value_type out_type<Box<int> >(Box<int>, Box<int>) = comdat any
...
define dso_local noundef i32 @main() #0 {
  ...
  %17 = call noundef i32 @Box<int>::value_type out_type<Box<int> >(Box<int>, Box<int>)(i32 %14, i32 %16)
...
define linkonce_odr dso_local noundef i32 @Box<int>::value_type out_type<Box<int> >(Box<int>, Box<int>)(i32 %0, i32 %1) #2 comdat {
  %3 = alloca %struct.Box, align 4
