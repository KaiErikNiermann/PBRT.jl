...
\TODO{Context, motivation, research questions, and original contribution could be organized in subsections.}
...
\subsection{Personal Contributions} \label{s:personal}
\TODO{This section is required for duo theses. Here the individual and joint contributions must be clear and explicit.}

\TODO{Notice that each student should sufficiently cover all the learning objectives of the thesis project. To this aim, a work division should be made such that each individual student does have enough coverage of those objectives.}